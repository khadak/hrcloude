...
function _emailValidate() {
    ...
    if (email == ""){
        ...
        emailValidate.textContent = "Note: Please enter a valid email id and include @ in your email id";
        emailValidate.style.display = "block";
        emailValidate.classList.add("input__note");
    }
    else {
...
function _calculateTax() {
    ...
    var salary =  document.getElementById("gSalary").value,
        ...
        isValidInvestment = (investment <= 150000),
    ...
    if (!isValidInvestment){
        var text = "Maximum applicable investments amount is 1,50,000";
        document.getElementById("investmentValidation").innerHTML = text;
    }
    else {
        document.getElementById("investmentValidation").innerHTML = " ";
    }
}
...
function _clearData() {
    ...
    document.getElementsByClassName("input__error")[0].value ="";
}
init();